...
Checkpoint state: integration and release gates passed; ready for commit

## Current objective

Land the fail-closed JPEG 2000, progressive MPEG-2, DTS, and TrueHD/MLP routes
without widening any codec, profile, layout, rate, or container claim beyond
exact evidence. The combined automated, artifact, production-build, and core
Jellyfin lifecycle gates now pass. Broader per-tuple media qualification and
long-run resource validation remain product work, not hidden support claims.
